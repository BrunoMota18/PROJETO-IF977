class MedicamentosController < ApplicationController
  ...
  def index
    @medicamentos = Medicamento.where cpf: Paciente.find(params[:paciente_id]).cpf
  end
  ...
  def create
    ...
    @medicamento.cpf = Paciente.find(params[:paciente_id]).cpf
    respond_to do |format|
      if @medicamento.save
        puts medicamento_params
        format.html { redirect_to medicamento_path(@medicamento, paciente_id: params[:paciente_id]), notice: 'Medicamento was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @medicamento.update(medicamento_params)
        format.html { redirect_to medicamento_path(@medicamento, paciente_id: params[:paciente_id]), notice: 'Medicamento was successfully updated.' }
  ...
  def destroy
    @medicamento.destroy
    respond_to do |format|
      format.html { redirect_to medicamentos_url(paciente_id: params[:paciente_id]), notice: 'Medicamento was successfully destroyed.' }
  ...
  private
    ...
    def medicamento_params
      params.require(:medicamento).permit(:nome, :descricao, :cpf)
    end
end
